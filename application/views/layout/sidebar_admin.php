      ...
      <div data-active-color="white" data-background-color="black" data-image="app-assets/img/sidebar-bg/01.jpg" class="app-sidebar">
        ...
        <div class="sidebar-content">
          <div class="nav-container">
            ...
            <li class=" nav-item <?= $this->uri->segment(1) === 'range_nilai' ? 'active' : '' ?>"><a href="<?= site_url('range_nilai') ?>"><i class="icon-calculator"></i><span data-i18n="" class="menu-title">Range Nilai</fspan></a></li>
